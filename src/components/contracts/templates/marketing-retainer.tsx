...
export function MarketingRetainer({ data }: { data: ContractTemplateData }) {
  return (
    <div className="w-[800px] mx-auto bg-[#FFF5F6] min-h-[1000px] print:min-h-0 text-slate-800 font-sans shadow-sm print:shadow-none print:w-full print:max-w-none print:bg-[#FFF5F6]">
      {/* Dynamic Header */}
      <div className="p-16 print:p-8 pb-12 relative overflow-hidden print:break-after-page">
        ...
        <div className="relative z-10 flex justify-between items-start mb-16 print:mb-8">
          <div className="mt-8">
            {data.agencyLogo ? (
        ...
        <div className="relative z-10 grid grid-cols-2 gap-16 print:gap-8 bg-white p-12 shadow-sm border border-rose-100 rounded-[2.5rem]">
          <div>
      ...
      {/* Content */}
      <div className="px-16 py-8 space-y-8 print:space-y-4 bg-white mx-8 rounded-3xl shadow-sm border border-rose-50 mb-16 print:mb-8">
      ...
      {/* Signatures */}
      <div className="p-20 print:p-10 bg-rose-950 text-rose-50 print:break-inside-avoid">
        <h3 className="text-5xl font-black mb-8 text-white tracking-tight">Let&apos;s Get Started</h3>
        <p className="text-rose-200 mb-16 print:mb-8 max-w-xl text-lg leading-relaxed">Please sign below to authorize the commencement of our partnership. All digital signatures are legally binding.</p>
