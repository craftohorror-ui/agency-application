  ...
  return (
    <div className="bg-white min-h-[1056px] w-[816px] mx-auto shadow-sm border-t-[16px]" style={{ borderColor: heavyDark, fontFamily: 'Arial, sans-serif' }}>
      <div className="p-12">
        ...
        {/* Client Block */}
        <section className="mb-12 border-b-4 pb-8 break-inside-avoid print-avoid-break" style={{ borderColor: heavyDark }}>
        ...
        {/* Signatures */}
        <section className="break-inside-avoid print-avoid-break border-t-8 pt-12" style={{ borderColor: heavyDark }}>
